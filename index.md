---
layout: default
title: PReSto: Using PReSto's custom reconstruction engine to modify, customize and visualize paleoclimate reconstructions
---
---
...
### June 2-4, 2026, Marina del Rey, Los Angeles, California
...
The PReSto Platform, at [https://paleopresto.org/](https://paleopresto.org/) does several things, including:
...
* Enables users to rerun, adjust input data and parameters, and customize paleoclimate reconstructions for their own purposes.
...
* *Learning objectives:* Introduction to the PReSto platform;  basics of paleoclimate reconstruction approaches; use PReSto's Custom Reconstruction Engine
...
### Location and format
This training will be in-person in Marina del Rey, Los Angeles. The workshop will consist of a blend of lectures and directed tutorials, as well as dedicated time for participants to explore applying the PReSto platform and Custom Reconstruction Engine to their own applications. Participants will be expected to present the outcome of the workshop on the last day.

### Participating
* Register [here](https://forms.gle/xveiXkEHQEwcxkvY8) by **February 10th, 2026**. 
